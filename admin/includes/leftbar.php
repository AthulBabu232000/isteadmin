	<nav class="ts-sidebar">
			...
			<li><a href="events.php"><i class="fa fa-user-times"></i> &nbsp;Events</a>
			</li>
			</li>
			<li><a href="execom.php"><i class="fa fa-briefcase"></i> &nbsp;Execom</a>
			</li>
			...
			<li><a href="../index.php"><i class="fa fa-user-times"></i> &nbsp;Register</a>
			</li>
			</ul>
